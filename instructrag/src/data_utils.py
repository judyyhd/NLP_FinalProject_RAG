...
def format_prompt(
    ...
    #     print("SEE HERE", dataset_name)
    #     print("SEE HERE", 'rationale_generation_postfix_' + dataset_name)
    #     print("SEE HERE", prompt_dict['rationale_generation_postfix_' + dataset_name])
    #     print(target_prefix)
    # elif len(demos) > 0:
    ...
    target_prefix += prompt_dict['rationale_generation_postfix_' + dataset_name]
    target_prefix += prompt_dict['assistant_prefix']

    # print("doc_prompt\n", doc_prompt)
    # print("query_prompt\n", query_prompt)
    # print("target_prefix\n", target_prefix)
    # print("final input\n", doc_prompt + query_prompt + target_prefix)
...
def format_prompt_with_data_list(
    ...
    n_docs: int = 5,
    demos: list = [],
    do_rationale_generation: bool = True,
):
